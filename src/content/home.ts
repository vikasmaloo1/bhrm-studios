...
export const editorial = {
  ...
  index: '02',
  heading: 'A website that looks great and does nothing for your revenue is an expensive piece of art.',
  intro:
  ...
  stages: [
    {
      ...
      gates: [
        ...
        { kind: 'hard', text: 'You approve the problem statement and the goals we are optimizing for.' },
      ],
    },
    {
      number: '02',
      ...
      gates: [
        ...
        { kind: 'hard', text: 'You approve the fixed scope. Changes now go through a change request.' },
      ],
    },
    {
      number: '03',
      ...
      gates: [
        ...
        { kind: 'hard', text: 'You review and approve the final designs. Engineering waits for the green light.' },
      ],
    },
    {
      number: '04',
      ...
      gates: [
        ...
        { kind: 'hard', text: 'You walk through the working build and confirm it does what Stage 2 promised.' },
      ],
    },
    {
      number: '05',
      ...
      gates: [
        { kind: 'soft', text: 'Full internal test pass: automated where it makes sense, manual where it matters.' },
    ...
    },
    {
      ...
      gates: [
        { kind: 'soft', text: 'A clear handover checklist so you know exactly what has been delivered.' },
      ],
    },
    {
      number: '07',
...
export const cta = {
  ...
  index: '04',
  heading: 'Tell us what you are building. We will tell you honestly if we are the right people for it.',
